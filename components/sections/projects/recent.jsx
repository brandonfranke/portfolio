						...
						return (
							...
							<article key={index} className={css.project}>
								<span className={css.header}>
									<a href={html_url} rel="noreferrer" target="_blank">{name} <Icon icon={[ 'far', 'arrow-up-right-from-square' ]} /></a>
								...
								<span className={css.details}>
									...
									<p><Icon icon={[ 'far', 'star' ]} /> {watchers}</p>
									<p><Icon icon={[ 'far', 'code-branch' ]} /> {forks_count}</p>
